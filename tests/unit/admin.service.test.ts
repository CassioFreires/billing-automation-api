...
describe('AdminService.getMetrics', () => {
  it('MRR soma apenas planos pagos ativos e vigentes', async () => {
    ...
    repo.allSubscriptions.mockResolvedValue([
      { plan: 'pro', status: 'active', trialEndsAt: null, currentPeriodEnd: future }, // 22900
      { plan: 'essencial', status: 'active', trialEndsAt: null, currentPeriodEnd: future }, // 11900
    ...
    expect(m.mrrCents).toBe(22900 + 11900);
